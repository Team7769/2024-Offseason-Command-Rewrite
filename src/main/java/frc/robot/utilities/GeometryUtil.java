...
public class GeometryUtil {
    ...
    public static Translation2d kSpeaker = isRedAlliance() ? Constants.FieldConstants.kRedSpeaker : Constants.FieldConstants.kBlueSpeaker;
    public static Translation2d kZone = isRedAlliance() ? Constants.FieldConstants.kRedZone : Constants.FieldConstants.kBlueZone;        
